...
<!--Designed and generated by Altova StyleVision Enterprise Edition 2017 sp2 (x64) - see http://www.altova.com/stylevision for more information.-->
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:altova="http://www.altova.com" xmlns:altova-xfi="http://www.altova.com/xslt-extensions/xbrl" xmlns:altovaext="http://www.altova.com/xslt-extensions" xmlns:array="http://www.w3.org/2005/xpath-functions/array" xmlns:clitype="clitype" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:iso4217="http://www.xbrl.org/2003/iso4217" xmlns:ix="http://www.xbrl.org/2008/inlineXBRL" xmlns:java="java" xmlns:link="http://www.xbrl.org/2003/linkbase" xmlns:map="http://www.w3.org/2005/xpath-functions/map" xmlns:math="http://www.w3.org/2005/xpath-functions/math" xmlns:sps="http://www.altova.com/StyleVision/user-xpath-functions" xmlns:xbrldi="http://xbrl.org/2006/xbrldi" xmlns:xbrli="http://www.xbrl.org/2003/instance" xmlns:xff="http://www.xbrl.org/2010/function/formula" xmlns:xfi="http://www.xbrl.org/2008/function/instance" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:svg="http://www.w3.org/2000/svg" exclude-result-prefixes="#all">
    <xsl:import href="../xml/Draft%20Quote%20Reports%20v3.5_attribute-sets.xslt"/>
	...
	<xsl:param name="SV_GeneratedFileNamePrefix" select="if ( $SV_BaseOutputFileName ) then $SV_BaseOutputFileName else &apos;Draft Quote Reports v3.5&apos;" as="xs:string?"/>
	<xsl:variable name="XML" select="/"/>
	<xsl:import-schema schema-location="Quote%20Data%20v2.2.xsd" use-when="system-property('xsl:is-schema-aware')='yes'"/>
	<xsl:variable name="fo:layout-master-set">
		<fo:layout-master-set>
			<fo:simple-page-master master-name="page-master-0-even" margin-left="0.0in" margin-right="0.0in" page-height="8.50in" page-width="11in" margin-top="-0.030in" margin-bottom="0.0in">
			    <fo:region-body margin-left="0.5in" margin-right="0.5in" margin-top="1.50in" margin-bottom="1.50in" column-count="1" column-gap="0.50in"/>
				<fo:region-before region-name="even-page-header" overflow="hidden" extent="1.50in"/>
				<fo:region-after region-name="even-page-footer" overflow="hidden" extent="1.50in"/>
			</fo:simple-page-master>
			<fo:simple-page-master master-name="page-master-0-odd" margin-left="0.0in" margin-right="0.0in" page-height="8.50in" page-width="11in" margin-top="-0.030in" margin-bottom="0.0in">
			    <fo:region-body margin-left="0.5in" margin-right="0.5in" margin-top="1.50in" margin-bottom="1.50in" column-count="1" column-gap="0.50in"/>
				<fo:region-before region-name="odd-page-header" overflow="hidden" extent="1.50in"/>
				<fo:region-after region-name="odd-page-footer" overflow="hidden" extent="1.50in"/>
			</fo:simple-page-master>
					...
					<x:xmpmeta xmlns:x="adobe:ns:meta/">
						<rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
							<rdf:Description rdf:about="" xmlns:xmp="http://ns.adobe.com/xap/1.0/">
								<xmp:CreatorTool>Altova StyleVision Enterprise Edition 2017 sp2 (x64) (http://www.altova.com)</xmp:CreatorTool>
							</rdf:Description>
						</rdf:RDF>
					</x:xmpmeta>
				</fo:declarations>
				<fo:page-sequence master-reference="page-master-0" initial-page-number="auto" format="1" force-page-count="no-force">
					...
					<fo:static-content flow-name="odd-page-header">
						<fo:block-container overflow="hidden" display-align="before">
						    <fo:block xsl:use-attribute-sets="__header_odd">
						        <fo:block-container absolute-position="absolute" left="-4.40cm">
						        <fo:block>
						            <fo:external-graphic padding-left="90mm" content-height="80%">
						                <xsl:attribute name="src">
						                    <xsl:text>url(</xsl:text>
						                    <xsl:call-template name="altova:double-backslash">
						                        <xsl:with-param name="text">
						                            <xsl:value-of
						                                select="string(&apos;file:\\\C:\xTeros\xTeros\Images\header_xteros2.svg&apos;)"/>
						                        </xsl:with-param>
						                        <xsl:with-param name="text-length">
						                            <xsl:value-of
						                                select="string-length(string(&apos;file:\\\C:\xTeros\xTeros\Images\header_xteros2.svg&apos;))"/>
						                        </xsl:with-param>
						                    </xsl:call-template>
						                    <xsl:text>)</xsl:text>
						                </xsl:attribute>
								...
								<fo:block-container height="1.50in" width="11in" overflow="hidden">
								    <fo:block-container absolute-position="absolute" height="1.06in" left="22.40cm" top="0in" width="6cm" overflow="hidden">
									    <fo:block padding-top="10.8mm">
											<xsl:variable name="altova:sUrlOrData" select="&apos;../Logo/Meltzer%20logo%20M%20Small.jpg&apos;"/>
											...
											<fo:external-graphic content-height="65%" content-width="65%">
												<xsl:attribute name="src">
													<xsl:text>url(</xsl:text>
													<xsl:call-template name="altova:double-backslash">
														<xsl:with-param name="text">
														    <xsl:value-of select="string(&apos;file:\\\C:\xTeros\xTeros\Images\meltzerLg.svg&apos;)"/>
														</xsl:with-param>
														<xsl:with-param name="text-length">
														    <xsl:value-of select="string-length(string(&apos;file:\\\C:\xTeros\xTeros\Images\meltzerLg.svg&apos;))"/>
														</xsl:with-param>
													</xsl:call-template>
													<xsl:text>)</xsl:text>
												</xsl:attribute>
								    ...
								    <fo:block-container absolute-position="absolute" height="1.06in" left="1cm" top="0in" width="2.24cm" overflow="hidden">
									    <fo:block padding-top="7.8mm">
											<xsl:variable name="altova:sUrlOrData" select="&apos;../../../Demo/Diamond%20Marina/Diamond%20Marina%20Logo%20St.png&apos;"/>
											<xsl:variable name="altova:seqWidthHeight" as="xs:integer*">
												<xsl:choose use-when="function-available('altovaext:get-width-and-height-from-image-data')">
													<xsl:when test="unparsed-text-available($altova:sUrlOrData, 'x-binarytobase64')">
														<xsl:sequence select="altovaext:get-width-and-height-from-image-data(xs:base64Binary(unparsed-text($altova:sUrlOrData, 'x-binarytobase64')))"/>
											...
											<fo:external-graphic content-height="0.6in" content-width="0.6in">
												<xsl:attribute name="src">
													<xsl:text>url(</xsl:text>
													<xsl:call-template name="altova:double-backslash">
														<xsl:with-param name="text">
														    <xsl:value-of select="string(&apos;file:\\\C:\xTeros\xTeros\Images\Diamond%20Marina%20Logo%20St.svg&apos;)"/>
														</xsl:with-param>
														<xsl:with-param name="text-length">
														    <xsl:value-of select="string-length(string(&apos;file:\\\C:\xTeros\xTeros\Images\Diamond%20Marina%20Logo%20St.svg&apos;))"/>
														</xsl:with-param>										
													</xsl:call-template>
													<xsl:text>)</xsl:text>
												</xsl:attribute>
								    ...
								    <fo:block-container xsl:use-attribute-sets="__header_address_right">
								        <fo:block xsl:use-attribute-sets="__header_address_content">
										    <fo:inline padding-left="49mm">
										        <xsl:text>&#xA0;Jack Abel</xsl:text>
										    </fo:inline>
										    <altova:line-break/>
										    <fo:inline>
										        <xsl:text> 6500 Rock Spring Drive, STE 500,Bethesda, MD 20817</xsl:text>
										    </fo:inline>
										    <altova:line-break/>
										    <fo:inline>
										        <xsl:text>Phone: 301-581-7376</xsl:text>
										    </fo:inline>
										    
										    <fo:inline>
										        <xsl:text>&#xA0;&#xA0;Email: </xsl:text>
										    </fo:inline>
										    <altova:hyperlink href="{&apos;agency@xteros.com&apos;}" text-decoration="none" color="#595959">
										        <fo:inline>
										            <xsl:text>jabel@meltzergroup.com</xsl:text>
										        </fo:inline>
										    </altova:hyperlink>
										</fo:block>
									</fo:block-container>
								    
								    <fo:block-container border-right="solid white 1.5pt" absolute-position="absolute" height="0.86cm" left="8.63cm" top="0.3cm" width="2.78cm" overflow="hidden">
								        <fo:block start-indent="8mm" color="white" line-height="90%">								            
								            <fo:inline font-family="Garamond" font-size="7pt">
								                <xsl:text>Effective Month</xsl:text>
								            </fo:inline>
								            <altova:line-break/>
								            <fo:inline font-family="Garamond" font-size="10pt">
								                <xsl:text>April 2017</xsl:text>
								            </fo:inline>
								        </fo:block>
								    </fo:block-container>
								    
								    <fo:block-container absolute-position="absolute" height="0.86cm" left="11.87cm" top="0.3cm" width="1.29in" overflow="hidden">
									    <fo:block color="white" line-height="90%">
											<!--<fo:inline font-family="Calibri light" font-size="8pt">
												<xsl:text>Quote: 12-58795</xsl:text>
											</fo:inline>
											<altova:line-break/>-->
									        <fo:inline font-family="Garamond" font-size="7pt">
									        ...
									        <altova:line-break/>
									        <fo:inline font-family="Garamond" font-size="10pt">
									            <xsl:text>21st February 2017</xsl:text>
									        </fo:inline>
										</fo:block>
									</fo:block-container>
								    <fo:block-container color="white" absolute-position="absolute" height="1.16cm" left="6.50cm" top="16mm" width="5.78cm" overflow="hidden">
								        <fo:block>
								            <fo:inline font-family="Garamond" font-size="25pt">
								                <xsl:text>Quote 12-58795</xsl:text>
								            </fo:inline>
								        </fo:block>
								    </fo:block-container>
								    
								    <fo:block-container xsl:use-attribute-sets="__header_address_left">
								        <fo:block xsl:use-attribute-sets="__header_address_content">
								            <fo:inline>
									            <xsl:text>Diamond Marina</xsl:text>
									        </fo:inline>
									        <altova:line-break/>
								            <fo:inline>
									            <xsl:text>15903 Somerville Drive,</xsl:text>
									        </fo:inline>
									        <altova:line-break/>
									        <fo:inline>
									            <xsl:text>Rockville, MD 20850</xsl:text>
									        </fo:inline>
											<!--<altova:hyperlink href="{&apos;mailto:shannon@diamondmarina.com&apos;}" text-decoration="underline" color="blue">
												<fo:inline font-family="Calibri light" font-size="7pt">
													<xsl:text>shannon@diamondmarina.com</xsl:text>
												</fo:inline>
											</altova:hyperlink>
											<altova:line-break/>
											<fo:inline font-family="Calibri light" font-size="7pt">
						    ...
						    <fo:block xsl:use-attribute-sets="__header_block">
						        <fo:leader xsl:use-attribute-sets="__leader"/>
						    </fo:block>
						</fo:block-container>
					</fo:static-content>
					                ...
					                <fo:block>
					                    <fo:external-graphic padding-left="90mm" content-height="80%">
					                        <xsl:attribute name="src">
					                            ...
					                            <xsl:call-template name="altova:double-backslash">
					                                <xsl:with-param name="text">
					                                    <xsl:value-of select="string(&apos;file:\\\C:\xTeros\xTeros\Images\header_xteros2.svg&apos;)"/>
					                                </xsl:with-param>
					                                <xsl:with-param name="text-length">
					                                    <xsl:value-of select="string-length(string(&apos;file:\\\C:\xTeros\xTeros\Images\header_xteros2.svg&apos;))"/>
					                                </xsl:with-param>
					                            </xsl:call-template>
					                            <xsl:text>)</xsl:text>
					                        </xsl:attribute>
					...
					<fo:static-content flow-name="odd-page-footer">			
					    ...
					    <fo:block-container height="2.78cm" absolute-position="absolute" left="0cm" top="15mm">
					        <fo:block>
					            <fo:external-graphic content-width="90%">
					                <xsl:attribute name="src">
					                    <xsl:text>url(</xsl:text>
					                    <xsl:call-template name="altova:double-backslash">
					                        <xsl:with-param name="text">
					                            <xsl:value-of select="string(&apos;file:\\\C:\xTeros\xTeros\Images\footer_xteros3.svg&apos;)"/>
					                        </xsl:with-param>
					                        <xsl:with-param name="text-length">
					                            <xsl:value-of select="string-length(string(&apos;file:\\\C:\xTeros\xTeros\Images\footer_xteros3.svg&apos;))"/>
					                        </xsl:with-param>
					                    </xsl:call-template>
					                    <xsl:text>)</xsl:text>
					                </xsl:attribute>
					    ...
					    <fo:block-container width="5.76cm" top="19mm" left="23.46cm" height="2.18cm" absolute-position="absolute">
					        <fo:block>
					            <fo:external-graphic content-width="6%" content-height="6%" padding-left="15mm">
					                <xsl:attribute name="src">
					                    <xsl:text>url(</xsl:text>
					                    <xsl:call-template name="altova:double-backslash">
					                        <xsl:with-param name="text">
					                            <xsl:value-of select="string(&apos;file:\\\C:\xTeros\xTeros\Images\xteros.svg&apos;)"/>
					                        </xsl:with-param>
					                        <xsl:with-param name="text-length">
					                            <xsl:value-of select="string-length(string(&apos;file:\\\C:\xTeros\xTeros\Images\xteros.svg&apos;))"/>
					                        </xsl:with-param>
					                    </xsl:call-template>
					                    <xsl:text>)</xsl:text>
					                </xsl:attribute>
					    ...
					    <fo:block-container width="2.76cm" top="23mm" left="26.66cm" height="2.18cm" absolute-position="absolute">
					        <fo:block>
					            <fo:external-graphic content-width="12%" content-height="12%" padding-left="0mm">
					                <xsl:attribute name="src">
					                    <xsl:text>url(</xsl:text>
					                    <xsl:call-template name="altova:double-backslash">
					                        <xsl:with-param name="text">
					                            <xsl:value-of select="string(&apos;file:\\\C:\xTeros\xTeros\Images\arrow.svg&apos;)"/>
					                        </xsl:with-param>
					                        <xsl:with-param name="text-length">
					                            <xsl:value-of select="string-length(string(&apos;file:\\\C:\xTeros\xTeros\Images\arrow.svg&apos;))"/>
					                        </xsl:with-param>
					                    </xsl:call-template>
					                    <xsl:text>)</xsl:text>
					                </xsl:attribute>
					    ...
					    <fo:block-container width="4.76cm" top="20mm" left="21.86cm" height="2.18cm" absolute-position="absolute">					       
					        <fo:block>
					            <fo:inline color="#595959" font-family="Garamond" font-size="6pt" padding-left="21mm">
					                <xsl:text>Powered by</xsl:text>
					            </fo:inline>
					            <altova:line-break/>
					            <fo:block line-height="70%" space-before="-5mm">
					                <fo:inline color="#1477BA" font-family="Garamond" font-size="20pt">
					                    <xsl:text>GET STARTED</xsl:text>
					                </fo:inline>
					                <altova:line-break/>
					                <altova:hyperlink href="{&apos;http://www.xteros.org&apos;}" color="#929395" font-family="Garamond" font-size="8pt" padding-left="21mm">
					                    <xsl:text>http://www.xteros.org</xsl:text>			                					        	
					                </altova:hyperlink>
					            </fo:block>
					        </fo:block>
					    </fo:block-container>
					    
					    <fo:block-container width="7.50cm" top="18.80mm" left="11cm" height="2.18cm" absolute-position="absolute" font-size="7pt">
					        <fo:block line-height="2.9mm" text-align="justify">			         
					            
					            <fo:inline font-family="Open Sans Extrabold" color="white">
					                <xsl:text>Disclaimer:</xsl:text>
					            </fo:inline>
					            <altova:line-break/>					    
					            <fo:inline font-family="Open Sans Light" color="white">
					                <xsl:text>Lorem Ipsum is simply dummy text of the printing typesetting
                                             industry.Lorem Ipsum has been the industry's standard dummy text
                                             ever since the 1500s, when an unknown printer took a gallery of type and scrambled of Lorem Ipsum.</xsl:text></fo:inline>          
					        </fo:block>
					    </fo:block-container>
					    
					    <fo:block-container width="6cm" top="23.90mm" left="0.5cm" height="2.18cm" absolute-position="absolute">
					        <fo:block line-height="2.6mm" text-align="justify">
					            <fo:inline font-family="Open Sans Light" color="white" font-size="23.5pt">
					                <xsl:text>1</xsl:text>
					            </fo:inline>
					            <fo:inline font-family="Garamond" color="white" font-size="16.5pt">
					                <xsl:text>&#xA0;Quote</xsl:text>
					            </fo:inline>
					        </fo:block>
					    </fo:block-container>
					    
					    <fo:block-container height="0.70in">
					        <fo:block>
					            <xsl:variable name="altova:table">
					                <fo:table width="100%" table-layout="fixed" border-spacing="2pt">
					                    ...
					                    <fo:table-body start-indent="0pt">
					                        <fo:table-row>
					                            <fo:table-cell number-columns-spanned="2" padding="0" display-align="center" color="#929395">
					                                <fo:block padding-top="11mm" font-size="10pt">
					                                    <fo:block start-indent="21.86cm">
					                                        <fo:page-number font-size="10pt"/>
					                                        <fo:inline>
					                                            <xsl:text>/</xsl:text>
					                                        </fo:inline>
					                                    ...
					                                    <!--<fo:block text-align="center">
															<fo:leader font-weight="lighter" leader-pattern="rule" rule-thickness="1" leader-length="100%" color="black"/>
														</fo:block>-->
					                                </fo:block>
					                            </fo:table-cell>
					                        </fo:table-row>
					                        <!--<fo:table-row>
												<!-\-<fo:table-cell font-size="10pt" padding="0" display-align="center">
													<fo:block text-align="center">
														<fo:inline font-family="Calibri light" font-size="10pt">
															<xsl:text>Employee Census</xsl:text>
														</fo:inline>
													</fo:block>
												</fo:table-cell>-\->
												<!-\-<fo:table-cell font-size="10pt" padding="0" display-align="center">
					...
					<fo:flow flow-name="xsl-region-body">
					    <!--<fo:block xsl:use-attribute-sets="__header_block">
					        <fo:leader xsl:use-attribute-sets="__leader"></fo:leader>
					    </fo:block>-->
					    <fo:block>
							<xsl:for-each select="$XML">
								<altova:line-break/>
								<fo:block-container height="3.24in" width="9.06in" overflow="hidden">
									<fo:block-container absolute-position="absolute" height="2.55in" left="1.40in" text-align="left" top="0in" width="2.22in" overflow="hidden">
										<fo:block>
											<altova:line-break/>
											<fo:inline color="#0b5e90" font-family="Calibri light" font-size="14pt">
												<xsl:text>Employer Contribution</xsl:text>
											</fo:inline>
											<xsl:variable name="altova:table">
																...
																<xsl:for-each select="for $altova:nodePseudo in $altova:nodesNextPseudo return key(&apos;altova:id-key&apos;, $altova:nodePseudo/@altova:sNodeId, document($altova:nodePseudo/@altova:sDocumentUri))">
																	...
																	<fo:table-cell padding="2pt" display-align="center">
																		<fo:block text-align="left">
																			<xsl:for-each select="eRate">
																				<altova:inline-container-substitute font-family="Calibri light" font-size="12pt">
																					<xsl:apply-templates/>
																	...
																	<fo:table-cell padding="2pt" display-align="center">
																		<fo:block text-align="left">
																			<fo:inline font-family="Calibri light" font-size="12pt">
									...
									<fo:block-container absolute-position="absolute" height="1.74in" left="1.40in" top="1.40in" width="7.17in" overflow="hidden">
										<fo:block>
											<altova:line-break/>
											<fo:inline color="#0b5e90" font-family="Calibri light" font-size="14pt">
												<xsl:text>Selected Plans</xsl:text>
											</fo:inline>
											<xsl:variable name="altova:table">
												<fo:table table-layout="fixed" width="100%" border-spacing="2pt">
													<fo:table-column column-width="proportional-column-width(1)"/>
													...
													<fo:table-header start-indent="0pt">
														<fo:table-row>
															...
															<fo:table-cell padding="2pt" display-align="center">
																<fo:block text-align="center">
																	<fo:inline font-family="Calibri light" font-size="10pt">
																		<xsl:text>Estimated Cost</xsl:text>
																	</fo:inline>
																</fo:block>
															</fo:table-cell>
														</fo:table-row>
													...
													<fo:table-body start-indent="0pt">
														<xsl:for-each select="Quote">
															<xsl:for-each select="plans">
																<fo:table-row background-color="{if ( position() mod 2 = 0 ) then &quot;white&quot; else &quot;	#ebebeb&quot;}">
																	<fo:table-cell padding="2pt" display-align="center">
																		<fo:block text-align="left">
																			<altova:inline-container-substitute font-family="Calibri light" font-size="10pt">
																	...
																	<fo:table-cell padding="2pt" display-align="center">
																		<fo:block text-align="center">
																			...
																			<xsl:for-each select="planInfo">
																				<xsl:for-each select="estimatedCost">
																					<altova:inline-container-substitute font-family="Calibri light" font-size="10pt">
																						<fo:inline>
									...
									<fo:block-container absolute-position="absolute" height="2.52in" left="5.80in" text-align="left" top="0in" width="2.83in" overflow="hidden">
										<fo:block>
											<altova:line-break/>
											<fo:inline color="#0b5e90" font-family="Calibri light" font-size="14pt">
												<xsl:text>Estimated Monthly Premium</xsl:text>
											</fo:inline>
											<xsl:variable name="altova:table">
												<fo:table table-layout="fixed" width="100%" border-spacing="2pt">
													...
													<xsl:variable name="altova:ColumnData">
														<xsl:for-each select="Quote">
															<altova:Element altova:sDesignElemId="7" altova:sNodeId="{generate-id(.)}" altova:sDocumentUri="{document-uri(root(.))}">
																<xsl:for-each select="total">
													...
													<fo:table-body start-indent="0pt">
														<fo:table-row background-color="#ebebeb">
															<fo:table-cell padding="2pt" display-align="center">
																<fo:block text-align="left">
																	<fo:inline font-family="Calibri light" font-size="10pt">
																		<xsl:text>Company Cost</xsl:text>
																	</fo:inline>
																</fo:block>
															</fo:table-cell>
															...
															<xsl:for-each select="for $altova:nodePseudo in $altova:nodesNextPseudo return key(&apos;altova:id-key&apos;, $altova:nodePseudo/@altova:sNodeId, document($altova:nodePseudo/@altova:sDocumentUri))">
																<xsl:variable name="altova:posCurrPseudo" select="position()"/>
																<xsl:variable name="altova:nodeCurrPseudo" select="$altova:nodesNextPseudo[ $altova:posCurrPseudo ]"/>
																<xsl:variable name="altova:nodesNextPseudo" select="$altova:nodeCurrPseudo/altova:Element[ @altova:sDesignElemId = 8 ]"/>
																<xsl:for-each select="for $altova:nodePseudo in $altova:nodesNextPseudo return key(&apos;altova:id-key&apos;, $altova:nodePseudo/@altova:sNodeId, document($altova:nodePseudo/@altova:sDocumentUri))">
																	<xsl:variable name="altova:posCurrPseudo" select="position()"/>
																	<xsl:variable name="altova:nodeCurrPseudo" select="$altova:nodesNextPseudo[ $altova:posCurrPseudo ]"/>
																	<fo:table-cell padding="2pt" display-align="center">
																		<fo:block text-align="left">
																			...
																			<xsl:for-each select="employerValue">
																				<altova:inline-container-substitute font-family="Calibri light" font-size="10pt">
																					<fo:inline>
														...
														<fo:table-row>
															<fo:table-cell padding="2pt" display-align="center">
																<fo:block text-align="left">
																	<fo:inline font-family="Calibri light" font-size="10pt">
																		<xsl:text>Employee Cost</xsl:text>
																	</fo:inline>
																</fo:block>
															</fo:table-cell>
															<xsl:variable name="altova:nodesNextPseudo" select="$altova:ColumnData/altova:Element[ @altova:sDesignElemId = 7 ]"/>
																...
																<xsl:for-each select="for $altova:nodePseudo in $altova:nodesNextPseudo return key(&apos;altova:id-key&apos;, $altova:nodePseudo/@altova:sNodeId, document($altova:nodePseudo/@altova:sDocumentUri))">
																	...
																	<fo:table-cell padding="2pt" display-align="center">
																		<fo:block text-align="left">
																			...
																			<xsl:for-each select="employeeValue">
																				<altova:inline-container-substitute font-family="Calibri light" font-size="10pt">
																					<fo:inline>
																						<xsl:value-of select="format-number(number(string(.)), '0.00')"/>
																					</fo:inline>
														...
														<fo:table-row background-color="#ffff57">
															<fo:table-cell padding="2pt" display-align="center">
																<fo:block text-align="left">
																	<fo:inline font-family="Calibri light" font-size="10pt">
																		<xsl:text>Monthly Premium</xsl:text>
																	</fo:inline>
																</fo:block>
															</fo:table-cell>
															<xsl:variable name="altova:nodesNextPseudo" select="$altova:ColumnData/altova:Element[ @altova:sDesignElemId = 7 ]"/>
																...
																<xsl:for-each select="for $altova:nodePseudo in $altova:nodesNextPseudo return key(&apos;altova:id-key&apos;, $altova:nodePseudo/@altova:sNodeId, document($altova:nodePseudo/@altova:sDocumentUri))">
																	...
																	<fo:table-cell padding="2pt" display-align="center">
																		<fo:block text-align="left">
																			...
																			<altova:inline-container-substitute font-family="Calibri light" font-size="10pt">
																				<xsl:value-of select="format-number(number(employerValue+employeeValue), '0.00')"/>
																			</altova:inline-container-substitute>
																		</fo:block>
																	</fo:table-cell>
																</xsl:for-each>
								...
								<altova:line-break/>
								<fo:inline color="#0b5e90" font-family="Calibri light" font-size="14pt">
									<xsl:text>Premium Detail</xsl:text>
								</fo:inline>
								<xsl:variable name="altova:table">
									<fo:table table-layout="fixed" width="100%" border-spacing="2pt">
										<fo:table-column column-width="0.390in"/>
										...
										<xsl:variable name="altova:ColumnData"/>
										<fo:table-header start-indent="0pt">
											<fo:table-row background-color="#57c0ff">
												<fo:table-cell padding="2pt" display-align="center">
													<fo:block text-align="left"/>
												</fo:table-cell>
												<fo:table-cell padding="2pt" display-align="center">
												...
												<fo:table-cell padding="2pt" display-align="center">
													<fo:block text-align="left">
														<fo:inline font-family="Calibri light" font-size="10pt">
															<xsl:text>Enroll Status</xsl:text>
														</fo:inline>
													</fo:block>
												</fo:table-cell>
												<fo:table-cell padding="2pt" display-align="center">
												...
												<fo:table-cell padding="2pt" display-align="center">
													<fo:block text-align="left">
														<fo:inline font-family="Calibri light" font-size="10pt">
															<xsl:text>Employer Cost</xsl:text>
														</fo:inline>
													</fo:block>
												</fo:table-cell>
												<fo:table-cell padding="2pt" display-align="center">
													<fo:block text-align="left">
														<fo:inline font-family="Calibri light" font-size="10pt">
															<xsl:text>Selected Plan</xsl:text>
														</fo:inline>
													</fo:block>
												</fo:table-cell>
											</fo:table-row>
											...
											<xsl:for-each select="Quote">
												<xsl:for-each select="employees">
													<fo:table-row background-color="{if ( position() mod 2 = 0 ) then &quot;white&quot; else &quot;	#ebebeb&quot;}">
														...
														<fo:table-cell padding="2pt" display-align="center">
															<fo:block text-align="left">
																<xsl:for-each select="first_name">
																	<altova:inline-container-substitute font-family="Calibri light" font-size="10pt">
																		<xsl:apply-templates/>
																	</altova:inline-container-substitute>
																</xsl:for-each>
														...
														<fo:table-cell padding="2pt" display-align="center">
															<fo:block text-align="left">
																<xsl:for-each select="smoker">
																	<altova:inline-container-substitute color="red" font-family="Calibri light" font-size="10pt">
																		<xsl:apply-templates/>
																	</altova:inline-container-substitute>
																</xsl:for-each>
															</fo:block>
														...
														<fo:table-cell padding="2pt" display-align="center">
															<fo:block text-align="left">
																...
																<altova:inline-container-substitute font-family="Calibri light" font-size="10pt">
																	<xsl:value-of select="format-number(number(employerValue+employeeValue), '000.00')"/>
																</altova:inline-container-substitute>
															</fo:block>
														</fo:table-cell>
														<fo:table-cell padding="2pt" display-align="center">
															<fo:block text-align="left">
																...
																<xsl:for-each select="spouseTotalValue">
																	<altova:inline-container-substitute font-family="Calibri light" font-size="10pt">
																		<fo:inline>
																			<xsl:value-of select="format-number(number(string(.)), '0.00')"/>
																		</fo:inline>
														...
														<fo:table-cell padding="2pt" display-align="center">
															<fo:block text-align="left">
																...
																<xsl:for-each select="childrenTotalValue">
																	<altova:inline-container-substitute font-family="Calibri light" font-size="10pt">
																		<fo:inline>
																			<xsl:value-of select="format-number(number(string(.)), '0.00')"/>
																		</fo:inline>
														...
														<fo:table-cell padding="2pt" display-align="center">
															<fo:block text-align="center">
																<altova:inline-container-substitute font-family="Calibri light" font-size="10pt">
																	<xsl:value-of select="planIndex+1"/>
																</altova:inline-container-substitute>
															</fo:block>
														</fo:table-cell>
													</fo:table-row>
